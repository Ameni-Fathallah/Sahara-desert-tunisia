...
// Add event listener to the menu icon to toggle navbar
...
document.addEventListener('click', function(event) {
    ...
    console.log('Navbar:', navbar.contains(event.target));
    console.log('Menu Icon:', menuIcon.contains(event.target));
    
    const isClickInsideNavbar = navbar.contains(event.target) || menuIcon.contains(event.target);
